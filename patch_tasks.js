...
const filePath = path.join(__dirname, 'tasks.html');
...
`;
if (!content.includes('.sub-switcher-wrap')) {
    content = content.replace('/* ── Header ── */', cssAdd + '\n/* ── Header ── */');
}

// 2. Header and Tabs
const oldHeader = `  <div class="app-header">
...
const oldTaskSheetHeader = `  <div class="sheet-header">
...
const newTaskSheetHeader = `  <div class="sheet-header">
...
// 4. Tab Views Replacement
const oldViews = `    <!-- TASKS TAB -->
    <div id="view-tasks">
...
console.log('Successfully patched Phase 1 structural HTML into tasks.html.');
